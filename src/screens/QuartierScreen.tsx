...
const fc = StyleSheet.create({
  boutiqueSpace: { position: 'relative', paddingBottom: 12 },
  boutiqueSpaceNight: { paddingBottom: 12 },
  floorTile: { position: 'absolute', bottom: 0, left: -12, right: -12, height: 20, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.15, shadowRadius: 6 },
  nameRow:    { marginTop: 8, maxWidth: 140 },
  name:       { fontSize: 13, fontWeight: '800', color: C.textDark, textAlign: 'center', letterSpacing: -0.3 },
  metaRow:    { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 4, justifyContent: 'center' },
  ratingPill: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: '#FEF3C7', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12, shadowColor: '#F59E0B', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 2 },
  ratingStar: { fontSize: 10, color: '#F59E0B' },
  ratingTxt:  { fontSize: 11, fontWeight: '800', color: '#B45309' },
  statusDot:  { width: 7, height: 7, borderRadius: 3.5 },
  statusTxt:  { fontSize: 11, fontWeight: '700', color: C.textLight },
});
...
const md = StyleSheet.create({
  ...
  banner: { paddingTop: 60, paddingBottom: 28, paddingHorizontal: 24, alignItems: 'center', gap: 12, borderBottomLeftRadius: 28, borderBottomRightRadius: 28, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.12, shadowRadius: 12 },
  closeBtn: { position: 'absolute', top: 60, left: 20, width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.3)', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: 'rgba(255,255,255,0.5)' },
  closeBtnText: { color: C.white, fontSize: 20, fontWeight: 'bold' },
  bannerEmoji: { fontSize: 56 },
  bannerTitle: { fontSize: 28, fontWeight: '800', color: C.white, letterSpacing: -0.5 },
  content: { padding: 24, gap: 24, paddingBottom: 40 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: C.white, padding: 14, borderRadius: 16, borderWidth: 1.5, borderColor: C.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4 },
  infoRow: { flexDirection: 'row', gap: 10, flexWrap: 'wrap' },
  sectorBadge: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 3 },
  sectorText: { fontSize: 14, fontWeight: '700' },
  locBadge: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 14, backgroundColor: C.bg, borderWidth: 1.5, borderColor: C.border },
  locText: { fontSize: 14, fontWeight: '700', color: C.textMid },
  sectionTitle: { fontSize: 18, fontWeight: '800', color: C.textDark, marginTop: 12, letterSpacing: -0.3 },
  description: { fontSize: 15, color: C.textMid, lineHeight: 24, backgroundColor: C.white, padding: 16, borderRadius: 16, borderWidth: 1.5, borderColor: C.border },
  infoGrid: { flexDirection: 'row', gap: 12, marginTop: 12 },
  infoItem: { flex: 1, backgroundColor: C.white, borderRadius: 16, padding: 16, borderWidth: 1.5, borderColor: C.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 4 },
  infoLabel: { fontSize: 12, color: C.textLight, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
  infoValue: { fontSize: 16, fontWeight: '800', color: C.textDark },
  bestSellerCard: { backgroundColor: C.warning + '15', borderRadius: 16, padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 2, borderColor: C.warning, shadowColor: C.warning, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 6 },
  bestSellerLabel: { fontSize: 13, fontWeight: '700', color: C.warning, textTransform: 'uppercase', letterSpacing: 0.5 },
  bestSellerValue: { fontSize: 16, fontWeight: '800', color: C.textDark },
  divider: { height: 1, backgroundColor: C.border, marginVertical: 12 },
  ctaBtn: { borderRadius: 16, paddingVertical: 18, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.2, shadowRadius: 10 },
  ctaBtnText: { fontSize: 17, fontWeight: '800', letterSpacing: -0.3 },
  ctaBtnDisabled: { backgroundColor: C.bg, borderRadius: 16, paddingVertical: 18, alignItems: 'center', borderWidth: 1.5, borderColor: C.border },
  ctaBtnDisabledText: { fontSize: 17, fontWeight: '700', color: C.textLight },
  favBtn: { alignItems: 'center', paddingVertical: 16, backgroundColor: C.white, borderRadius: 16, borderWidth: 2, borderColor: C.border },
  favBtnText: { fontSize: 15, fontWeight: '700', color: C.accent },
});
