...
const GROUPS = [
  {
    label: 'PRINCIPAL',
    items: [
      { route: 'BusinessDashboard', label: 'Tableau de bord', d: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z' },
      { route: 'Products',          label: 'Produits',        d: 'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16zM3.27 6.96 12 12l8.73-5.04M12 22V12' },
      { route: 'Orders',            label: 'Commandes',       d: 'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 10h6M9 14h6' },
      { route: 'Customers',         label: 'Clients',         d: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 7a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75' },
    ],
  },
  {
    label: 'VENTES & OUTILS',
    items: [
      { route: 'POS',         label: 'Caisse (POS)', d: 'M2 3h20v14H2zM8 21h8M12 17v4' },
      { route: 'Analytics',   label: 'Analytics',    d: 'M3 3v18h18M7 14l4-4 3 3 5-6' },
      { route: 'Marketing',   label: 'Marketing',    d: 'M3 11l19-9-9 19-2-8-8-2z' },
      { route: 'Billing',     label: 'Facturation',  d: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8' },
      { route: 'Receivables', label: 'Créances',     d: 'M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6' },
    ],
  },
  {
    label: 'BOUTIQUE',
    items: [
      { route: 'BoutiqueAppearance', label: 'Apparence',   d: 'M2 13.5V19a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.5M12 2L2 7l10 5 10-5-10-5z' },
      { route: 'VendooShop',         label: 'Vendoo Shop', d: 'M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0' },
      { route: 'PaymentSettings',    label: 'Paiements',   d: 'M1 4h22v16H1zM1 10h22' },
      { route: 'Sponsorship',        label: 'Parrainage',  d: 'M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z' },
    ],
  },
  {
    label: 'COMMUNAUTÉ',
    items: [
      { route: 'QuartierScreen',  label: 'Quartier',  d: 'M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4zM8 2v16M16 6v16' },
      { route: 'BoutiqueCatalog', label: 'Catalogue', d: 'M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5A2.5 2.5 0 0 0 6.5 22H20V2H6.5A2.5 2.5 0 0 0 4 4.5v15z' },
    ],
  },
  {
    label: 'GESTION',
    items: [
      { route: 'Notifications',      label: 'Notifications',    d: 'M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0' },
      { route: 'BoutiqueManagement', label: 'Gestion boutique', d: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM9 22V12h6v10' },
      { route: 'CaseManagement',     label: 'Affaires',         d: 'M20 7H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2' },
      { route: 'Settings',           label: 'Réglages',         d: 'M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.09a2 2 0 0 1-1-1.74v-.51a2 2 0 0 1 1-1.72l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z' },
    ],
  },
];
...
GROUPS.forEach(g => g.items.forEach(i => { ROUTE_LABELS[i.route] = i.label; }));
...
const Sidebar: React.FC<{ activeRoute: string; onLogout: () => void }> = ({ activeRoute, onLogout }) => {
  ...
  return (
    <View style={s.sidebar}>
      ...
      <View style={s.footer}>
        <View style={s.footerAvatar}><Text style={s.footerAvatarTxt}>CB</Text></View>
        <View style={{ flex: 1 }}>
          <Text style={s.footerName}>Cyril B.</Text>
          <Text style={s.footerRole}>Admin · Plan Pro</Text>
        </View>
  ...
  return (
    <View style={s.topbar}>
      ...
      <View style={s.breadcrumb}>
        ...
        {routeName !== 'BusinessDashboard' && (
          <>
            <Ico d="M9 18l6-6-6-6" color={T.faint} size={14} sw={2} />
            <Text style={s.breadCurrent}>{label}</Text>
          </>
        )}
      </View>
