...
// Utilise Firebase Admin avec Firebase CLI credentials
// Usage: node scripts/cleanup-boutiques-node.js

const admin = require('firebase-admin');

// Initialiser Firebase Admin avec le projet Firebase CLI
admin.initializeApp({
