...
// Utilise Firebase CLI credentials (déjà authentifié)
// Usage: npx firebase functions:shell --project vendoo-67f37 --import scripts/cleanup-boutiques-firestore.js

const admin = require('firebase-admin');

// Initialiser avec les credentials par défaut de Firebase CLI
admin.initializeApp({
